        ...
        <>
            ...
            <section id="about-us" className="px-6 py-24 md:px-20 bg-[#FBFBFF] flex flex-col-reverse lg:flex-row justify-center items-center lg:space-x-20">
                <div className="w-full lg:basis-1/2">
                    ...
                    <p className="text-lg text-[#2F2D2D] uppercase leading-[200.5%] py-10">GenZtechies is a community for Gen Z developers, founders, designers, and techies across Africa to connect, learn, and discover life-changing opportunities.<br></br> <br></br>Africa has the largest population of unemployed youths, talent is equally distributed but opportunity is not. Beginning in 2022, we organize Gen Z HackFest as a unique 2-in-1 conference and hackathon to bridge this gap in our own little way.</p>
