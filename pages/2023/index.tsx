        ...
        <>
            ...
            <section id="about-us" className="px-6 py-24 md:px-20 bg-[#FBFBFF] flex flex-col-reverse lg:flex-row justify-center items-center lg:space-x-20">
                <div className="w-full lg:basis-1/2">
                    ...
                    <br>Africa has the largest population of unemployed youths, talent is equally distributed but opportunity is not. Beginning in 2022, we organize Gen Z HackFest as a unique 2-in-1 conference and hackathon to bridge this gap in our own little way.</p>
